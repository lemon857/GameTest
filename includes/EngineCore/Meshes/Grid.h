...
public:
	...
	Grid(glm::vec3 pos, glm::vec2 size, unsigned int count_cols, unsigned int count_rows, glm::vec4 color, RenderEngine::Material* pMaterial);
	Grid(glm::vec3 start_pos, glm::vec3 end_pos, glm::vec2 size, glm::vec4 color, RenderEngine::Material* pMaterial);
	~Grid();
